      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4 flex-wrap gap-2">
              <SocialIcon
                href="https://www.facebook.com/share/1Krjwmf8yR/?mibextid=wwXIfr"
                icon="facebook"
                label="Facebook Page"
              />
              <SocialIcon
                href="https://www.facebook.com/share/g/193YA7oPzP/?mibextid=wwXIfr"
                icon="facebook-f"
                label="Facebook Group"
              />
              <SocialIcon
                href="https://www.linkedin.com/company/imali-defi/"
                icon="linkedin"
                label="LinkedIn"
              />
              <SocialIcon
                href="https://www.instagram.com/imali_defi?igsh=MXZieHV1MTJnem5weA%3D%3D&utm_source=qr"
                icon="instagram"
                label="Instagram"
              />
              <SocialIcon
                href="https://bsky.app/profile/imali-defi.bsky.socia"
                icon="square"
                label="Bluesky"
              />
              <SocialIcon
                href="https://discord.gg/wSNq32q5"
                icon="discord"
                label="Discord"
              />
              <SocialIcon
                href="https://www.threads.net/@imali_defi"
                icon="threads"
                label="Threads"
              />
              <SocialIcon
                href="https://x.com/imalidefi?s=21&t=zPxjF8QLzW9SL7pH-m60Hw"
                icon="x-twitter"
                label="X (Twitter)"
              />
              <SocialIcon
                href="https://github.com/IMALI-DEFI/imali"
                icon="github"
                label="GitHub"
              />
            </div>
