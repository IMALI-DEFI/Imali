...
const HowToUse = () => {
  ...
  const handleGetStarted = () => {
    navigate("/"); // Navigate to home or any other starting point
  };
      ...
      <div className="container mx-auto max-w-6xl bg-white shadow-lg p-8 rounded-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 border rounded-lg bg-white">
            ...
            <p className="text-gray-700">
              Navigate to the <span className="font-semibold">Presale</span> page where you can purchase IMALI tokens. 
              You can buy these directly using ETH or MATIC, or purchase them through an exchange. 
              Make sure the tokens are sent to your connected wallet.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-lg bg-white">
            ...
            <p className="text-gray-700">
              To earn additional rewards, visit the <span className="font-semibold">Staking</span> dashboard. 
              Enter the amount of tokens you wish to stake and confirm the transaction in MetaMask. 
              A small staking fee may be deducted as defined in the contract.
            </p>
          </div>
          ...
          <div className="p-6 border rounded-lg bg-white">
            ...
            <p className="text-gray-700">
              Yield farming allows you to provide liquidity and earn extra rewards. 
              Deposit your tokens into the <span className="font-semibold">Yield Farming</span> pool,
          ...
          <div className="p-6 border rounded-lg bg-white">
            ...
            <p className="text-gray-700">
              Our <span className="font-semibold">Lending</span> platform lets you use your tokens as collateral to borrow stablecoins or deposit tokens to earn interest.
              <br /><br />
