...
describe("IMALI Staking & Yield Farming", function () {
    ...
    before(async () => {
        ...
        const YieldFarm = await ethers.getContractFactory("IMALIYieldFarming");
        ...
        // 🚀 Transfer IMALI tokens to staking contract
        // 🚀 Mint More IMALI Tokens First (for both staking and users)
    ...
    it("User should be able to stake IMALI tokens", async () => {
        ...
        expect(userBalance).to.equal(ethers.parseEther("475"));  // ✅ Adjust expected balance
