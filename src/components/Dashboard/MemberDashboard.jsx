...
export default function MemberDashboard() {
  ...
  const fetchBotStatus = useCallback(async () => {
    ...
    try {
      ...
      if (isRunning && runningBot?.strategy) {
          ...
          <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-3 sm:p-4">
            <div className="mb-3">
              ...
              <p className="text-xs text-white/40">
                Manage trading accounts, wallets, billing and activation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {SETTINGS_TABS.slice(0, 4).map((tab) => (
                <div
                  ...
                  title={
                    tab.id === "billing"
                      ? "View your membership, billing and subscription."
                      : tab.id === "trading"
                      ? "Connect and manage your trading accounts."
                      : tab.id === "wallets"
                      ? "Connect and manage blockchain wallets."
                      : tab.id === "activation"
                      ? "Review trading activation and account readiness."
                      : tab.label
                  }
                >
                  <SettingsTab
